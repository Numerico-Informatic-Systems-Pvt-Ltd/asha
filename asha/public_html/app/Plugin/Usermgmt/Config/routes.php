...
Router::connect('/customer_login', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'customer_login'));
Router::connect('/admin_panel', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'admin_panel'));
