...
$i=1;
	...
	$plotEstimate['Estimate'] = $this->requestAction('estimates/get_by_plot_estimate/'.	
														$plotEstimate['PlotEstimate']['id']);
	
	foreach($plotEstimate['Estimate'] as $estimate):
