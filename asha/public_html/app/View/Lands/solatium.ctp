...
<?php
 ...
 echo $this->Form->create('Land',array('action'=>'updateestimate'
									,'onsubmit'=>"return validate_total_amount(".$countOwners.")")); ?>
<input type="hidden" id="countOwners" value="<?=$countOwners ?>" />
<?php
	//debug($lacase);
...
<h1 style="padding:4px; font-size:16px;">
	<b>LA Case Number ::</b> 
	<?php echo $lacase['Lacase']['la_case_number'] ." :: Calculation for LAND";?>
</h1>
...
&nbsp;&nbsp;|&nbsp;&nbsp;
<b>Meterial Date :: </b> <?php echo $this->Time->format("F jS, Y",$meterial_date); ?> 
&nbsp;&nbsp;|&nbsp;&nbsp;
<b>Date of 80% Payment :: </b><?php echo $this->Time->format("F jS, Y",$date_of_80_payment);?>
&nbsp;&nbsp;|&nbsp;&nbsp;
<b>Date of Award :: </b><?php echo $this->Time->format("F jS, Y",$award_date);?>
   ...
   <!-- <td>Class</td>-->
		...
		?>
            ...
            <td><?php echo $lands['Land']['rsplot_no']; ?></td>
			 ...
			 'value'=>$lands['Classification']['old_value'],'onblur'=>'check_value('.$i.')')); ?></td>
              ...
              <td><?php  echo $this->Form->input('Land.'.$i.'.3',array('label'=>false,'onblur'=>'check_value('.$i.')')); ?></td>
	...
	<table>
		...
		<?php
			...
			if($landowner['shared_area'] && ($landowner['bargadar'] == 'N')):
