...
<?php
 ...
 echo $this->Form->create('Land',array('action'=>'updateestimatestructure',
											 'onsubmit' => 
...
<br />
<h3></b>-- Calculation For Structure --</b></h3>
</div>
<style>
...
-->             
            <!-- <td><?php echo $land['AcquisitionedArea'][0]['total']; ?></td>	-->
             ...
             <td><?php  echo $this->Form->input('Land.'.$i.'.area',array(
			 							'label'=>false,
										'value'=>$lands['Land']['structure_area'],
	...
	<table>
		...
		<?php
			...
			foreach($lands['LandsOwner'] as $landowner):
				if($landowner['structure_share'] && ($landowner['bargadar'] == 'N')):
				//debug($landowner);
...
-->             
            ...
            <?php $aqu=$lands['Land']['tree_area']*($landowner['tree_share']/10000); ?>
             <td><?php  
				echo $this->Form->input('Land.'.$i.'.area_clone',array('label'=>false,'value'=>$landowner['structure_share'],'readonly'=>'readonly'));
             ...
             <td><?php  echo $this->Form->input('Land.'.$i.'.1',array('label'=>false,
			 									'readonly' => 'readonly',
			 									'onfocus'=>'check_value_for_owner('.$i.')')); ?></td>
			 
              <td><?php  
			  				echo $this->Form->input('Land.'.$i.'.2',array('label'=>false,'value'=>'0.00',
