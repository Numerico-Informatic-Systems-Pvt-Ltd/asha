...
<?php
 ...
 echo $this->Form->create('Land',array('action'=>'updateestimatebargadar'
...
<?php
	...
	//debug($perior_date_of_80_payment);
...
/*        $diff = abs(strtotime($end_date) - strtotime($start_date));
		...
		*/
		...
		//three different interest calculation for compensession
...
<br />
<h3>Calculation for BARGADAR</h3>
</div>
<style>
...
<br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ ><br/ >
    ...
    <tr><th>Plot no</th>
   <!-- <td>Class</td>-->
    <th>Total Barga Effected Area</th>
    <th>JAL Rate</th>
    <th>Barga Percentage (%)</th>
    <th>old value</th>
    <th>paid 80%</th>
    <!--<th>tree value</th>-->
    <th>old value - 80%</th>
		...
		?>
            ...
            <td><?php echo $lands['Land']['rsplot_no']; ?></td>
             ...
             <td><?php  echo $this->Form->input('Land.'.$i.'.area',array('label'=>false,
			 		'value'=>$lands['Land']['total_barga_effected_area'],'readonly'=>'readonly')); ?></td>
             
             <td><?php  echo $this->Form->input('Land.'.$i.'.1',array('label'=>false,
			 'value'=>$classification['Classification']['old_value'])); ?></td>
             
             <td><?php  echo $this->Form->input('Land.'.$i.'.barga_percentage',array(
			 									'label'=>false,
												'onblur'=>'calculate_plot_barga_compensation('.$countOwners.')')); ?></td>

              <td><?php  echo $this->Form->input('Land.'.$i.'.2',array('label'=>false,
			  															'readonly'=>'readonly')); ?></td>
              
              
              <td><?php  echo $this->Form->input('Land.'.$i.'.3',array('label'=>false,
			  														'readonly'=>'readonly')); ?></td>
               ...
               <td><?php  echo $this->Form->input('Land.'.$i.'.9',array('label'=>false,
			   										'readonly'=>'readonly',
													)); ?></td>
                                                    
               <td><?php  echo $this->Form->input('Land.'.$i.'.10',array('label'=>false,
			   										'readonly'=>'readonly',
													)); ?></td>
               ...
               <td><?php  echo $this->Form->input('Land.'.$i.'.14',array('label'=>false,
			   														'readonly'=>'readonly')); ?></td>
                <?php
				...
				$day =  $periodforAdditionalCompensation3['1']['2'];
				 ...
				 echo $this->Form->input('Land.'.$i.'.dur3',
							array('type'=>'hidden','label'=>false,
							'readonly'=>'readonly','value'=>$year3));
				?>  
                <td><?php  echo $this->Form->input('Land.'.$i.'.15',array('label'=>false,
														'readonly'=>'readonly')); ?></td>
                 <td><?php  echo $this->Form->input('Land.'.$i.'.16',array('label'=>false,
				 										'readonly'=>'readonly')); ?></td>
                  <td><?php  echo $this->Form->input('Land.'.$i.'.17',array('label'=>false,
				  										'onchange'=>'modify_barga_compensation()')); ?>
                  <?php  echo $this->Form->input('Land.'.$i.'.3_check',array('label'=>false,
	...
	<table>
		...
		<?php
			$i=101;
			/* Just pass the LA CASE id for showing ESTIMATE */
			...
			if($landowner['barga_share'] && ($landowner['bargadar'] == 'Y')):
...
-->             
            ...
            <?php $aqu=$lands['Land']['acquisitioned_areas_value']*($landowner['shared_area']/10000); ?>
             <td><?php  
				echo $this->Form->input('Land.'.$i.'.area_clone',array('label'=>false,'value'=>$landowner['barga_share'],'readonly'=>'readonly'));
             ...
             <td><?php  echo $this->Form->input('Land.'.$i.'.1',array('label'=>false,
              ...
              <td><?php  
			  			...
			  			echo $this->Form->input('Land.'.$i.'.barga_percentage',array(
			  								'label'=>false,
											'readonly'=>'readonly'
											)); ?></td>
             ...
             <!-- <td>--><?php  echo $this->Form->input('Land.'.$i.'.4',array('label'=>false,
			 									'readonly'=>'readonly','value'=>0,'type'=>'hidden')); ?><!--</td>-->
               ...
               <td><?php  echo $this->Form->input('Land.'.$i.'.12',array('label'=>false,
			   											'readonly'=>'readonly')); ?></td>
               <!--<td>--><?php  echo $this->Form->input('Land.'.$i.'.13',array('label'=>false,
			   											'readonly'=>'readonly','type'=>'hidden')); ?><!--</td>-->
                <?php /*echo $this->Form->input('Land.'.$i.'.dur3y',
							array('type'=>'text','label'=>false,'value'=>$land['Lacase']['duration3_year'])); 
               echo $this->Form->input('Land.'.$i.'.dur3m',
               ...
               <td><?php  echo $this->Form->input('Land.'.$i.'.14',array('label'=>false,
                ...
                <td><?php  echo $this->Form->input('Land.'.$i.'.15',array('label'=>false,
                 ...
                 <td><?php  echo $this->Form->input('Land.'.$i.'.16',array('label'=>false,
				 					'readonly'=>'readonly')); ?></td>
                  <td><?php  echo $this->Form->input('Land.'.$i.'.17',array(
				  							'label'=>false)); ?>
                  <?php  echo $this->Form->input('Land.'.$i.'.3_check',array('label'=>false,
				  					'readonly'=>'readonly','type'=>'hidden')); ?></td>
