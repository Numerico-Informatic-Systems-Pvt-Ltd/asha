...
<?php echo $this->Form->create('PlotEstimate'); ?>
	<fieldset>
		<legend><?php echo __('Edit Plot Estimate'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PlotEstimate.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PlotEstimate.id'))); ?></li>
